    ...
    if ( hasInfrequentPosQgram.isTrue() || hasInfrequentQgramToken.isTrue() )
    {
      ...
      // check the join result
    	if(infrequentJoinedResult !=null){
    		this.browsePrefixInfrequentResult(query, infrequentJoinedResult, objectDatabase, hasReadInfrequentToken, prefixResult, visitedObjectMap, prefixResultFromInfrequentQgram, substringCandidates);
    	}
    }
